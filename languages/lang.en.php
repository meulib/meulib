...
define('WORDING_LIB_TITLE','OurLib Demo Library');
define('WORDING_LIB_MESSAGE','For demo and testing only. Data will be frequently deleted.');
define('WORDING_BROWSE_TITLE','Browse Collection');
define('WORDING_BDETAIL_TITLE','Book Detail');
define('WORDING_AUTHOR_BY','by');
define('WORDING_AUTHOR1','Author');
define('WORDING_AUTHORS','Authors');
define('WORDING_BOOK_COPIES','Book Copies');
define('WORDING_LENDERS','Lenders');
define('WORDING_SIGNUP_TITLE','Join');
define('WORDING_VISION_TITLE','Vision');
define('WORDING_MESSAGES_TITLE','Messages');
define('WORDING_MYBOOKS_TITLE','My Books');
define('WORDING_MYBORROWEDBOOKS_TITLE','My Borrowed Books');

define("WORDING_ME", "Me");
define("WORDING_MESSAGES_REPLY_ACTION", "Reply");
define("WORDING_LEND_ACTION", "Lend");
define("WORDING_ACCEPT_RETURN_ACTION", "Accept Return");
define("WORDING_REQUESTBOOK_ACTION", "Request Book");
define("WORDING_PENDING_REQUESTS", "Pending Requests");
define("WORDING_NO_PENDING_REQUESTS", "No Pending Requests");
define("WORDING_LEND_SUCCESS", "Recorded lending of book.");
define("WORDING_LEND_FAILURE", "There was some problem in recording the lend action.");
define("WORDING_RETURN_GETCONFIRMATION", "Please confirm. Book being returned by");
define("WORDING_RETURN_SUCCESS", "Book return recorded.");
define("WORDING_RETURN_FAILURE", "There was some problem in recording the book return.");

define('WORDING_FRMEMAIL','Email');
define('WORDING_FRMEMAIL2','Re-enter Email');
define('WORDING_FRMNAME','Name');
...
define("MESSAGE_VERIFICATION_MAIL_SENT", "Your account has been created successfully and we have sent you an email. Please click the VERIFICATION LINK within that mail. You may have to check your spam folder for the email.");
